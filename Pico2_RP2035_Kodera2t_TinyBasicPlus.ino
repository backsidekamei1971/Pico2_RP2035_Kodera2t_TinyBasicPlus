...
//#include <Adafruit_ILI9486.h> // Hardware-specific library
...
#define TFT_RST    22
#define TFT_DC     28
//Adafruit_ILI9486 tft = Adafruit_ILI9486(&SPI, TFT_CS,  TFT_DC, TFT_RST);
...
//	lcd.begin(16, 4);
//////
 // Serial.print("Hello! ILI9486 TFT Test");

  // Use this initializer if you're using a 1.8" TFT
  //tft.initR(INITR_BLACKTAB);   // initialize a ILI9486S chip, black tab
 // tft.begin();
   tft.setSpiKludge(false);
   tft.init();

  // Use this initializer (uncomment) if you're using a 1.44" TFT
  //tft.initR(INITR_144GREENTAB);   // initialize a ILI9486S chip, black tab
...
//  Serial.println("Initialized");
 ...
 // delay(500);
  ...
  // large block of text
  tft.fillScreen(ILI9486_BLACK);
  //testdrawtext("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur adipiscing ante sed nibh tincidunt feugiat. Maecenas enim massa, fringilla sed malesuada et, malesuada sit amet turpis. Sed porttitor neque ut ante pretium vitae malesuada nunc bibendum. Nullam aliquet ultrices massa eu hendrerit. Ut sed nisi lorem. In vestibulum purus a tortor imperdiet posuere. ", ILI9486_WHITE);
 // delay(1000);
  /////////////
//  delay(500);
  // init done
...
//				doEraseFrame(252); //Redraw screen up to that amount
	if (c != 13 and c != 10 and c != 8) {	//Not a backspace or return, just a normal character
		...
		cursorX += 1;
		if (cursorX < 21) {
	        tft.setCursor(cursorX*6+5,12*16+3);		
		tft.write(c);
		}
...
static void doEraseLine() {
        int xposi,yposi,yshift;
                yshift=12;
                yposi=yshift*16+3;
	        tft.fillRect(0,yposi-8,160,yposi,ILI9486_BLACK);
}
